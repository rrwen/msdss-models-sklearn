...
# -*- coding: utf-8 -*-
#
# msdss_models_sklearn documentation build configuration file
#
...
import os
import sys
sys.path.insert(0, os.path.abspath('../../msdss_models_sklearn'))

author = 'Richard Wen rrwen.dev@gmail.com'
project = 'msdss_models_sklearn'
description = 'Scikit-learn models for the Modular Spatial Decision Support Systems (MSDSS) framework'
...
htmlhelp_basename = 'msdss_models_sklearn_doc'
...
latex_documents = [
    (master_doc, 'msdss_models_sklearn.tex', project.replace('_', '\\_') + ' Documentation',
     author, 'manual'),
]
